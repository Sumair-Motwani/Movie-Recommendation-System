-- 1. Create the Schema
CREATE DATABASE IF NOT EXISTS movie_rec_system;
...
-- 6. Create MovieGenres Table (Bridge Table)
...
-- 9. Create RecommendationHistory Table
...
INSERT INTO Admins (Name, Email, Password) VALUES ('Super Admin', 'admin@test.com', 'admin123');
